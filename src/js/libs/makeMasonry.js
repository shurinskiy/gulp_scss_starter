...
* @вызов
* 
import { makeMasonry } from "../../js/libs/makeMasonry";
makeMasonry(document.querySelector('.masonry', {
...
export const makeMasonry = (element, options = {}) => {
	class Masonry {
		...
		init(flag = true) {
			if (flag) {
				...
				this.setLayout();
				this.handler = this.#throttle(this.setLayout.bind(this));
