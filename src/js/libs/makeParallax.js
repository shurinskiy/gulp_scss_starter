...
* блока блок-подложку из data-атрибута или из background-image, 
* с фоновым изображением исходного блока. При прокручивании страницы, 
* смещает подложку относительно родительского блока, со скоростью 
* определяемой коэффициентом из атрибута data-speed.
* 
* @исходная разметка 
* 
